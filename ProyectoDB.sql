--------------------------------------------------------
-- Archivo creado  - miércoles-noviembre-13-2024   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table ARMA
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into USUARIO01.MUNDO (ID_MUNDO,NOMBRE,FONDO,PISO,ID_CATEGORIA) values ('4','MUNDO ALCANTILADO','FondoAlcantilado.png','PISO1','LENG');
Insert into USUARIO01.MUNDO (ID_MUNDO,NOMBRE,FONDO,PISO,ID_CATEGORIA) values ('5','MUNDO BOSQUE','FondoBosque.png','PISO1','BIO');
Insert into USUARIO01.MUNDO (ID_MUNDO,NOMBRE,FONDO,PISO,ID_CATEGORIA) values ('6','MUNDO LAGO 1-1','FondoLago.png','PISO1','BIO');
